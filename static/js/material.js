...
MdElevatedButton.styles = [styles$10, styles$11, styles$12];
...
MdFilledButton.styles = [styles$10, styles$11, styles$$];
...
MdOutlinedButton.styles = [styles$10, styles$_];
...
MdTextButton.styles = [styles$10, styles$Z];
...
MdTonalButton.styles = [styles$10, styles$11, styles$Y];
...
MdCheckbox.styles = [styles$X, styles$W];
...
MdAssistChip.styles = [styles$T, styles$U, styles$V];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$Q = i$4 `.trailing.action{display:flex;padding:0 8px;--md-focus-ring-shape-start-start: var(--_container-shape-start-end);--md-focus-ring-shape-end-start: var(--_container-shape-end-end);--md-focus-ring-shape-end-end: var(--_container-shape-end-end);--md-focus-ring-shape-start-end: var(--_container-shape-start-end);--md-focus-ring-outward-offset: -2px}.trailing.action md-ripple{border-radius:50%;height:calc(1.3333333333*var(--_icon-size));inset:50% 0 0 50%;transform:translateX(-50%) translateY(-50%);width:calc(1.3333333333*var(--_icon-size))}:has(.trailing.action) .primary.action{padding-inline-end:0}.trailing.icon{color:var(--_trailing-icon-color);height:var(--_icon-size);width:var(--_icon-size)}:hover .trailing.icon{color:var(--_hover-trailing-icon-color)}:focus .trailing.icon{color:var(--_focus-trailing-icon-color)}:active .trailing.icon{color:var(--_pressed-trailing-icon-color)}.disabled .trailing.icon{color:var(--_disabled-trailing-icon-color);opacity:var(--_disabled-trailing-icon-opacity)}.selected .trailing.icon{color:var(--_selected-trailing-icon-color)}.selected:hover .trailing.icon{color:var(--_selected-hover-trailing-icon-color)}.selected:focus .trailing.icon{color:var(--_selected-focus-trailing-icon-color)}.selected:active .trailing.icon{color:var(--_selected-pressed-trailing-icon-color)}/*# sourceMappingURL=trailing-icon-styles.css.map */
`;
...
MdFilterChip.styles = [
    styles$T, styles$U, styles$Q, styles$R, styles$S
];
...
MdSuggestionChip.styles = [styles$T, styles$U, styles$P];
...
MdCircularProgress.styles = [styles$O];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$M = i$4 `:host{--_color: var(--md-divider-color, var(--md-sys-color-outline-variant, #cac4d0));--_thickness: var(--md-divider-thickness, 1px);box-sizing:border-box;color:var(--_color);display:flex;height:var(--_thickness);width:100%}:host([inset]),:host([inset-start]){padding-inline-start:16px}:host([inset]),:host([inset-end]){padding-inline-end:16px}:host::before{background:currentColor;content:"";height:100%;width:100%}@media(forced-colors: active){:host::before{background:CanvasText}}/*# sourceMappingURL=divider-styles.css.map */
`;
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$K = i$4 `@media(forced-colors: active){.fab{--md-focus-ring-outward-offset: 3px;border:1px solid ButtonText}.fab.extended{padding-inline-start:15px;padding-inline-end:19px}}/*# sourceMappingURL=forced-colors-styles.css.map */
`;
...
MdBrandedFab.styles = [styles$J, styles$L, styles$K];
...
MdFab.styles = [styles$J, styles$I, styles$K];
MdFab = __decorate([
    e$a('md-fab')
], MdFab);
...
MdFilledField.styles = [styles$G, styles$H];
...
MdOutlinedField.styles = [styles$G, styles$F];
...
MdFilledIconButton.styles = [styles$D, styles$E];
...
MdFilledTonalIconButton.styles = [styles$D, styles$C];
...
MdOutlinedIconButton.styles = [styles$D, styles$B];
...
MdStandardIconButton.styles = [styles$D, styles$A];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$z = i$4 `:host{--_color: var(--md-icon-color, inherit);--_font: var(--md-icon-font, "Material Symbols Outlined");--_font-variation-settings: var(--md-icon-font-variation-settings, inherit);--_size: var(--md-icon-size, 24px);--_weight: var(--md-icon-weight, 400);display:inline-flex;color:var(--_color);font-family:var(--_font);font-weight:var(--_weight);font-style:normal;font-size:var(--_size);font-variation-settings:var(--_font-variation-settings);line-height:1;overflow:hidden;letter-spacing:normal;text-transform:none;white-space:nowrap;word-wrap:normal;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;-moz-osx-font-smoothing:grayscale}span ::slotted(svg){fill:currentColor}span ::slotted(*){height:var(--_size);width:var(--_size)}/*# sourceMappingURL=icon-styles.css.map */
`;
...
MdLinearProgress.styles = [styles$y];
...
MdListItem.styles = [styles$w, styles$x];
...
MdListItemLink.styles = [styles$w, styles$x];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$v = i$4 `:host{--_container-color: var(--md-list-container-color, var(--md-sys-color-surface, #fef7ff));color:unset}.md3-list{background-color:var(--_container-color);border-radius:inherit;display:block;list-style-type:none;margin:0;min-width:inherit;outline:none;padding:8px 0;position:relative}/*# sourceMappingURL=list-styles.css.map */
`;
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$t = i$4 `:host{--_list-item-selected-container-color: var(--md-menu-item-list-item-selected-container-color, var(--md-sys-color-surface-container-highest, #e6e0e9));--_list-item-container-color: var(--md-menu-item-list-item-container-color, var(--md-sys-color-surface-container, #f3edf7));--md-list-item-list-item-container-color: var(--_list-item-container-color)}:host([selected]) .list-item{background-color:var(--_list-item-selected-container-color)}.list-item:has(.submenu:hover){--md-ripple-hover-opacity: 0}/*# sourceMappingURL=menu-item-styles.css.map */
`;
...
MdMenuItem.styles = [styles$w, styles$t, styles$x, styles$u];
...
MdMenuItemLink.styles = [styles$w, styles$t, styles$x, styles$u];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$s = i$4 `@media(forced-colors: active){.menu{border-style:solid;border-color:CanvasText;border-width:1px}}/*# sourceMappingURL=forced-colors-styles.css.map */
`;
...
MdMenu.styles = [styles$r, styles$s];
MdMenu = __decorate([
    e$a('md-menu')
], MdMenu);
...
MdSubMenuItem.styles = [styles$w, styles$t, styles$x, styles$u];
...
MdNavigationBar.styles = [styles$q];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$o = i$4 `.md3-navigation-drawer-modal{background-color:var(--_container-color);border-radius:var(--_container-shape);height:var(--_container-height)}.md3-navigation-drawer-modal.md3-navigation-drawer-modal--opened{inline-size:var(--_container-width)}.md3-navigation-drawer-modal .md3-navigation-drawer-modal__slot-content{min-inline-size:var(--_container-width);max-inline-size:var(--_container-width)}/*# sourceMappingURL=shared-styles.css.map */
`;
...
MdNavigationDrawer.styles = [styles$o, styles$p];
...
MdNavigationDrawerModal.styles = [styles$o, styles$n];
...
MdNavigationTab.styles = [styles$m];
...
MdOutlinedSegmentedButton.styles = [styles$i, styles$j];
...
MdOutlinedSegmentedButtonSet.styles = [styles$g, styles$h];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$d = i$4 `:host{color:unset;min-width:210px}.field{cursor:default;outline:none}.select{position:relative}.field,.select,md-menu{min-width:100%;max-width:inherit}.field,.select{width:100%}:host{display:inline-flex}.label{width:100%}:host([disabled]){pointer-events:none}/*# sourceMappingURL=shared-styles.css.map */
`;
...
MdFilledSelect.styles = [styles$d, styles$e, styles$f];
...
MdOutlinedSelect.styles = [styles$d, styles$b, styles$c];
...
MdSelectOption.styles = [styles$w, styles$t, styles$x, styles$u];
...
class Slider extends s$2 {
    ...
    renderHandle({ start, hover, label }) {
        ...
        ${n(this.withLabel, () => this.renderLabel(label))}
...
__decorate([
    e$9({ attribute: 'aria-label-start' })
], Slider.prototype, "ariaLabelStart", void 0);
__decorate([
    e$9({ attribute: 'aria-label-end' })
...
MdSwitch.styles = [styles$7, styles$8];
MdSwitch = __decorate([
    e$a('md-switch')
], MdSwitch);
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$5 = i$4 `:host{box-sizing:border-box;display:flex;justify-content:space-between;align-items:end;overflow:auto;scroll-behavior:smooth;scrollbar-width:none;position:relative}:host([hidden]){display:none}:host([variant~=vertical]:not([hidden])){display:inline-flex;flex-direction:column;align-items:stretch;gap:0px}:host::-webkit-scrollbar{display:none}::slotted(*){flex:1}::slotted([selected]){z-index:1}/*# sourceMappingURL=tabs-styles.css.map */
`;
