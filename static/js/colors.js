...
class DynamicColor {
    ...
    static calculateDynamicTone(args) {
        ...
        const desiredRatio = clampDouble(minRatio?.(stdRatio) ?? 1.0, maxRatio?.(stdRatio) ?? 21.0, currentRatio);
...
class ToneDeltaConstraint {
     ...
     */
    constructor(delta, keepAway, keepAwayPolarity) {
        this.delta = delta;
...
export { Scheme, applyTheme, argbFromRgb, themeFromSourceColor };
